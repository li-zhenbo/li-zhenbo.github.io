...
This is the first follow-up application of the MGHFP method. Its core innovation — embedding the composite Simpson quadrature formula into the classical GHFP framework — enables purely symbolic execution for the first time, without requiring any system parameter pre-assignment. All subsequent MGHFP work (IJNLM 2025, Phys. Scr. 2026) builds on this work.
