...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{gpa-roadmap.png}
\caption{Technical roadmap of the generalized Pad\'e approximation (GPA) research program. The five papers progress from the foundational definition (2013) through method extension (2014), integration with perturbation theory---GPLP (2016), extension to periodic solutions (2019), and asymmetric refinement (2022). The core design principle---matching basis functions to solution geometry (left sidebar)---guides every methodological choice. The bottom timeline summarizes the basis-geometry correspondence across the entire series.}
\label{fig:roadmap}
\end{figure}
